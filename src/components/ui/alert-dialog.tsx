...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // When closed, avoid intercepting pointer events so underlying UI remains clickable.
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // Prevent closed content from capturing pointer events (and help avoid focus being hidden while active)
